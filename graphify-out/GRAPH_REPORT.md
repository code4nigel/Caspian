...
## Summary
- 2081 nodes · 5265 edges · 119 communities (57 shown, 20 thin omitted)
...
Cohesion: 0.02
Nodes (28): android.app.RemoteAction, android.content.BroadcastReceiver, android.graphics.Bitmap, android.media.MediaPlayer, android.media.SoundPool, android.support.v4.media.session.MediaSessionCompat, android.view.TextureView, android.view.VelocityTracker (+20 more)
...
Cohesion: 0.10
Nodes (25): android.app.NotificationManager, android.content.Intent, android.content.SharedPreferences, android.media.AudioRecord, android.os.Bundle, android.os.Handler, android.speech.SpeechRecognizer, android.webkit.ValueCallback (+17 more)
...
Cohesion: 0.11
Nodes (16): android.graphics.PointF, android.graphics.Rect, android.widget.Button, android.widget.HorizontalScrollView, android.widget.LinearLayout, android.widget.TextView, DrawingView, Button (+8 more)
...
Cohesion: 0.14
Nodes (9): android.graphics.RectF, android.view.View, androidx.dynamicanimation.animation.SpringAnimation, CabRadialMenuView, OnRadialActionSelectedListener, CaspianPhysics, SpringAnimation, ViewProperty (+1 more)
...
Cohesion: 0.09
Nodes (16): android.animation.ValueAnimator, android.content.Context, android.graphics.Canvas, android.graphics.Paint, android.util.AttributeSet, android.view.MotionEvent, Override, Override (+8 more)

### Community 59 - "commands"
Cohesion: 0.29
...
- **Why does `MainActivity` connect `MainActivity` to `android.webkit.JavascriptInterface`, `.dpToPx`, `.getYouTubeTab`, `CaspianBridge`, `CaspianDownloadManager`, `betac/MainActivity.java`, `.updateOmniboxState`, `WhirlpoolOverlayView`, `MainActivity`, `CaspianWebView`, `android.view.View`, `BookmarkManager`, `GitHubUpdateManager`, `.getTabById`, `RecentsHorizontalScrollView`, `SwipeableViewFlipper`, `.resolve`, `.transitionToOrbState`, `WaveguardShield`, `android.content.Context`, `.showCardGridEditDialog`?**
  _High betweenness centrality (0.303) - this node is a cross-community bridge._
- **Why does `CaspianBridge` connect `android.webkit.JavascriptInterface` to `MainActivity`, `betac/MainActivity.java`, `CaskManager`, `GitHubUpdateManager`, `.getInstance`, `WaveguardShield`, `.switchCaspianCask`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `MainActivity` connect `MainActivity` to `.setupFloatingYouTubeRemote`, `.onBackPressed`, `.switchTab`, `.onCreate`, `CaspianBridge`, `betac/MainActivity.java`, `WhirlpoolOverlayView`, `android.view.View`, `BookmarkManager`, `.getActiveTab`, `android.content.Context`?**
...
- **Should `MainActivity` be split into smaller, more focused modules?**
  _Cohesion score 0.024502137420498383 - nodes in this community are weakly interconnected._
