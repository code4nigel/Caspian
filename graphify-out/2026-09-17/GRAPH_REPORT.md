...
## Summary
- 2336 nodes · 5934 edges · 137 communities (65 shown, 33 thin omitted)
...
Cohesion: 0.03
Nodes (19): android.graphics.Bitmap, AudioRecord, WebView, MainActivity, MultiTabDragState, CustomViewCallback, Handler, Intent (+11 more)
...
Cohesion: 0.08
Nodes (30): android.content.BroadcastReceiver, android.content.Intent, android.media.AudioRecord, android.media.MediaPlayer, android.media.SoundPool, android.os.Bundle, android.os.Handler, android.speech.SpeechRecognizer (+22 more)
...
Cohesion: 0.11
Nodes (8): android.net.Uri, androidx.webkit.JavaScriptReplyProxy, androidx.webkit.WebMessageCompat, Override, MediaMessageCallback, TrustedMediaMessageHandler, TrustedMediaMessageHandlerTest, WebMessageListener
...
Cohesion: 0.09
Nodes (7): HubActionCallback, Override, TrustedHubMessageHandler, TrustedHubMessageHandlerTest, WebViewSecurityPolicyTest, java.util.regex.Pattern, org.junit.Test
...
Cohesion: 0.14
Nodes (7): CaskItem, CaskManager, JSONObject, WebView, JSONObject, JSONObject, org.json.JSONObject
...
- **Why does `MainActivity` connect `MainActivity` to `android.webkit.JavascriptInterface`, `.dpToPx`, `android.webkit.WebView`, `.getYouTubeTab`, `CaspianDownloadManager`, `betac/MainActivity.java`, `android.net.Uri`, `WhirlpoolOverlayView`, `.updateOmniboxState`, `CaspianWebView`, `BookmarkManager`, `TabController`, `.restoreLastClosedBatch`, `.switchToTab`, `GitHubUpdateManager`, `RecentsHorizontalScrollView`, `.transitionToOrbState`, `WaveguardShield`, `.addTab`, `.getTabById`, `android.view.View`, `android.widget.TextView`, `.setupFloatingPod`, `CaskManager`?**
  _High betweenness centrality (0.290) - this node is a cross-community bridge._
- **Why does `CaspianBridge` connect `android.webkit.JavascriptInterface` to `MainActivity`, `android.webkit.WebView`, `WaveguardShield`, `.getInstance`, `CaskManager`, `GitHubUpdateManager`, `.switchCaspianCask`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `MainActivity` connect `MainActivity` to `android.webkit.WebView`, `.switchTab`, `android.content.Context`, `CaspianBridge`, `betac/MainActivity.java`, `android.net.Uri`, `android.view.View`, `MainActivity`, `android.widget.TextView`?**
...
- **Should `android.webkit.JavascriptInterface` be split into smaller, more focused modules?**
  _Cohesion score 0.028457653457653456 - nodes in this community are weakly interconnected._
- **Should `MainActivity` be split into smaller, more focused modules?**
  _Cohesion score 0.025870646766169153 - nodes in this community are weakly interconnected._
